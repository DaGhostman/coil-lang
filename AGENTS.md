...
- `ARCHIVE_VERSION` is 25; bump on incompatible bytecode, tag, or opcode changes. Static slots use `LoadStatic`/`StoreStatic`; `static_slot_count` is stored in the archive envelope.
