...
fn builtin_description(module: &str, name: &str, export: &BuiltinExport) -> String {
    let description = match (module, name) {
        ...
        ("regex", "compile") => "Compiles a regular expression.".into(),
        ("regex", "is_match") => "Checks whether a regular expression matches text.".into(),
        ("regex", "find") => "Returns the first regular-expression match.".into(),
        ("regex", "find_all") => "Returns all regular-expression matches.".into(),
        ("regex", "captures") => "Returns capture groups for the first match.".into(),
        ("regex", "captures_all") => "Returns capture groups for all matches.".into(),
        ("regex", "split") => "Splits text using a regular expression.".into(),
        ("regex", "replace") => "Replaces the first regular-expression match.".into(),
        ("regex", "replace_all") => "Replaces every regular-expression match.".into(),
        ...
        ("crypto", "sha256") => "Computes a SHA-256 digest.".into(),
        ("crypto", "sha512") => "Computes a SHA-512 digest.".into(),
        ("crypto", "blake3") => "Computes a BLAKE3 digest.".into(),
